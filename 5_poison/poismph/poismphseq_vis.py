...
DEFAULT_MODEL_PATH = SCRIPT_DIR / "poismphseq.keras"
DEFAULT_SEQ_FOLDER = ROOT_DIR / "dataset" / "data_mph_seq"
DEFAULT_READY_FOLDER = ROOT_DIR / "dataset" / "data_mph_ready"
DEFAULT_INPUT = ROOT_DIR / "dataset" / "poison" / "mph" / "seq"
...
POISON_SPECS = {
    "poisalt_mph_": {
        "label": 1,
        "auth": ("mphauth", "auth_mph_"),
        "mod": ("mphalt", "modalt_mph_"),
    },
    "poisspd_mph_": {
        "label": 2,
        "auth": ("mphauth", "auth_mph_"),
        "mod": ("mphspd", "modspd_mph_"),
    },
    "poispos_mph_": {
        "label": 3,
        "auth": ("mphauth", "auth_mph_"),
        "mod": ("mphpos", "modpos_mph_"),
    },
}
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Visualize generated MPH poison CSVs and optional model window scores."
    )
    parser.add_argument(
        "inputs",
        nargs="*",
        ...
        help="Poison CSV files or folders. Defaults to dataset/poison/mph/seq.",
    )
