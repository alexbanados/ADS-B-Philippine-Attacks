...
DEFAULT_MODEL_PATH = SCRIPT_DIR / "poisppsseq.keras"
DEFAULT_SEQ_FOLDER = ROOT_DIR / "dataset" / "data_pps_seq"
DEFAULT_READY_FOLDER = ROOT_DIR / "dataset" / "data_pps_ready"
DEFAULT_INPUT = ROOT_DIR / "dataset" / "poison" / "pps" / "seq"
...
POISON_SPECS = {
    "poisalt_pps_": {
        "label": 1,
        "auth": ("ppsauth", "auth_pps_"),
        "mod": ("ppsalt", "modalt_pps_"),
    },
    "poisspd_pps_": {
        "label": 2,
        "auth": ("ppsauth", "auth_pps_"),
        "mod": ("ppsspd", "modspd_pps_"),
    },
    "poispos_pps_": {
        "label": 3,
        "auth": ("ppsauth", "auth_pps_"),
        "mod": ("ppspos", "modpos_pps_"),
    },
}
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Visualize generated PPS poison CSVs and optional model window scores."
    )
    parser.add_argument(
        "inputs",
        nargs="*",
        ...
        help="Poison CSV files or folders. Defaults to dataset/poison/pps/seq.",
    )
