...
DEFAULT_MODEL_PATH = SCRIPT_DIR / "poiscebseq.keras"
DEFAULT_SEQ_FOLDER = ROOT_DIR / "dataset" / "data_ceb_seq"
DEFAULT_READY_FOLDER = ROOT_DIR / "dataset" / "data_ceb_ready"
DEFAULT_INPUT = ROOT_DIR / "dataset" / "poison" / "ceb" / "seq"
...
POISON_SPECS = {
    "poisalt_ceb_": {
        "label": 1,
        "auth": ("cebauth", "auth_ceb_"),
        "mod": ("cebalt", "modalt_ceb_"),
    },
    "poisspd_ceb_": {
        "label": 2,
        "auth": ("cebauth", "auth_ceb_"),
        "mod": ("cebspd", "modspd_ceb_"),
    },
    "poispos_ceb_": {
        "label": 3,
        "auth": ("cebauth", "auth_ceb_"),
        "mod": ("cebpos", "modpos_ceb_"),
    },
}
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Visualize generated CEB poison CSVs and optional model window scores."
    )
    parser.add_argument(
        "inputs",
        nargs="*",
        ...
        help="Poison CSV files or folders. Defaults to dataset/poison/ceb/seq.",
    )
