...
DEFAULT_MODEL_PATH = SCRIPT_DIR / "poisdvoseq.keras"
DEFAULT_SEQ_FOLDER = ROOT_DIR / "dataset" / "data_dvo_seq"
DEFAULT_READY_FOLDER = ROOT_DIR / "dataset" / "data_dvo_ready"
DEFAULT_INPUT = ROOT_DIR / "dataset" / "poison" / "dvo" / "seq"
...
POISON_SPECS = {
    "poisalt_dvo_": {
        "label": 1,
        "auth": ("dvoauth", "auth_dvo_"),
        "mod": ("dvoalt", "modalt_dvo_"),
    },
    "poisspd_dvo_": {
        "label": 2,
        "auth": ("dvoauth", "auth_dvo_"),
        "mod": ("dvospd", "modspd_dvo_"),
    },
    "poispos_dvo_": {
        "label": 3,
        "auth": ("dvoauth", "auth_dvo_"),
        "mod": ("dvopos", "modpos_dvo_"),
    },
}
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Visualize generated DVO poison CSVs and optional model window scores."
    )
    parser.add_argument(
        "inputs",
        nargs="*",
        ...
        help="Poison CSV files or folders. Defaults to dataset/poison/dvo/seq.",
    )
